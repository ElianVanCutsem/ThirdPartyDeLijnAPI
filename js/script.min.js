...
"</option>")}).fail(function(){console.log("there was an error searching locations")})}function k(b){b=b.coords.latitude+","+b.coords.longitude;a("#startSelect").append("<option value='"+b+"'>Your Location</option>");a("#destinationSelect").append("<option value='"+b+"'>Your Location</option>");a("#destinationSelect").show();a("#startSelect").show();a("#startSelect").val(b).change()}function g(a){a=a.substring(4,a.length-2);var b,c;if(4==a.length)return a.substring(0,1),c=a.substring(2,3),c+"m";5==
a.length&&(b=a.substring(0,1),c=a.substring(2,4));6==a.length&&(b=a.substring(0,2),c=a.substring(3,5));return b+"h"+c+"m"}function l(a){return 1E3>a?"0."+a+"km ":a/1E3+"km "}function m(){if(0<localStorage.length){a("#favouritesTitle").text("Your favourite routes:").show();a("#favourites").empty();for(var b=0,f=localStorage.length;b<f;++b)a("#favourites").append(localStorage.getItem(localStorage.key(b)))}else a("#favouritesTitle").text("favourites").hide(),a("#favourites").empty()}a(document).ready(function(){console.log("Loaded");
